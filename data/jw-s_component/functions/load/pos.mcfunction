...
##  Opérateurs
execute store result score a jw-s_calc run data get entity @s data.pos[0] 100
execute store result score b jw-s_calc run data get entity @s data.pos[1] 100
execute store result score c jw-s_calc run data get entity @s data.pos[2] 100
##  Application

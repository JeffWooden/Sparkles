...
execute if score @s jw-s_type matches 4 run summon marker ~ ~ ~ {Tags:["jw-s-shell","init","set_fuse","jw-s-fountain"],data:{item:{}},Passengers:[{id:"minecraft:marker",Tags:["jw-s-shell","child","init"]}]}
